...
if whiten_data:
    ...
    print(strain_L1_whiten)
    print(len(strain_L1_whiten))
...
for det in dets:
    ...
    if make_plots:
        ...
        utils.util_plot(time, timemax, SNR, pcolor, det, eventname, plottype, strain_whitenbp, tevent, template_match, template_fft, datafreq, d_eff, freqs, data_psd, fs)
